...
Specification for the **robot description** (URDF/XACRO) of the Spider quadruped robot. Defines the structural model, geometry, inertia, and kinematics of the robot using standard ROS2 URDF conventions with primitives (no external meshes in Hito 1).
